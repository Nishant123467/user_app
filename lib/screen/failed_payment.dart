...
class payment_failed extends StatefulWidget {
  const payment_failed({super.key});

  @override
  State<payment_failed> createState() => _payment_failedState();
}

class _payment_failedState extends State<payment_failed> {
    @override
  void initState() {
    super.initState();
